...
def main():
    ...
    if args.task == "vad":
        from whosaidwhat.pipe.fireredvad import non_stream_vad
        ...
        from whosaidwhat.pipe.fireredvad import stream_vad_full
        ...
        from whosaidwhat.pipe.fireredvad import non_stream_aed
